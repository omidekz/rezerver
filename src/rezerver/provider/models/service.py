...
NAME_FIELD, PRICE_MIN_FIELD, PRICE_MAX_FIELD, M2D_MIN_FIELD, M2D_MAX_FIELD, FIRST_PAY_FIELD, NEED2ACCEPT_FIELD = (
...
class Service(Model):
    ...
    parent = fields.ForeignKeyField("provider.Service", "children", fields.CASCADE)
